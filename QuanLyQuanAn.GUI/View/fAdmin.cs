...
namespace QuanLyQuanAn
{
    public partial class fAdmin : Form
    {
        ...
        private void ListAccount()
        {
            ...
            var ds = _accountService.GetAccounts();
        ...
        private void btnResetPassword_Click(object sender, EventArgs e)
        {
            string userName = txbUserName.Text.ToString();
            string passWord = "0";
            bool kt = _accountService.UpdateAccount(userName, passWord);
            if (kt == true)
            {
        ...
        private void btnEditAccount_Click(object sender, EventArgs e)
        {
            ...
            int temp = (int)numericUpDownType.Value;
            bool type = Convert.ToBoolean(temp);
            bool test = _accountService.UpdateAccountFormAdmin(userName, type);
            if (test == true)
            {
        ...
        private void btnDeleteAccount_Click(object sender, EventArgs e)
        {
            ...
            bool test = _accountService.DeleteAccount(userName);
            if (test == true)
            {
